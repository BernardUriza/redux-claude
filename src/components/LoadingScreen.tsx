...
export const LoadingScreen = ({ onLoadingComplete, duration = 3000 }: LoadingScreenProps) => {
  ...
  return (
    <div className={`fixed inset-0 z-50 bg-gradient-to-br from-gray-950 via-slate-900 to-gray-950 flex items-center justify-center transition-opacity duration-500 loading-safe-area ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
      
      {/* Medical Background Pattern */}
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-20 left-20 w-32 h-32 border border-cyan-500/20 rounded-full animate-pulse" />
        <div className="absolute top-40 right-32 w-24 h-24 border border-blue-500/20 rounded-full animate-pulse" style={{ animationDelay: '0.5s' }} />
        <div className="absolute bottom-32 left-40 w-20 h-20 border border-teal-500/20 rounded-full animate-pulse" style={{ animationDelay: '1s' }} />
        <div className="absolute bottom-20 right-20 w-28 h-28 border border-purple-500/20 rounded-full animate-pulse" style={{ animationDelay: '1.5s' }} />
      </div>
      ...
      <div className="relative z-10 max-w-md w-full mx-auto px-4 sm:px-8 loading-screen-mobile">
        ...
        <div className="text-center mb-6 sm:mb-8 animate-fade-in-up">
          ...
          <p className="text-slate-400 text-sm animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
        ...
        <div className="text-center animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
          <div className="bg-gradient-to-r from-slate-800/60 to-slate-700/60 backdrop-blur-xl rounded-2xl p-4 sm:p-6 border border-slate-600/40 shadow-xl">
            ...
            <div className="flex justify-center space-x-1">
              <div className="w-2 h-2 bg-cyan-400 rounded-full animate-loading-dots" style={{ animationDelay: '0ms' }} />
              <div className="w-2 h-2 bg-cyan-400 rounded-full animate-loading-dots" style={{ animationDelay: '0.2s' }} />
              <div className="w-2 h-2 bg-cyan-400 rounded-full animate-loading-dots" style={{ animationDelay: '0.4s' }} />
            </div>
          </div>
        </div>
