      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="prose prose-invert prose-sm max-w-none prose-headings:text-white prose-p:text-gray-300 prose-strong:text-white">
          <ReactMarkdown
            components={{
              h1: ({ children }) => (
                <h1 className="text-xl font-bold mb-4 text-white border-b border-gray-700 pb-2">
                  {children}
                </h1>
              ),
              h2: ({ children }) => (
                <h2 className="text-lg font-bold mb-3 text-blue-300">{children}</h2>
              ),
              h3: ({ children }) => (
                <h3 className="text-base font-semibold mb-2 text-blue-200">{children}</h3>
              ),
              ...
              {message.metadata.sessionId && (
                <div>
                  ...
                  <span className="ml-1 text-gray-300 font-mono text-xs">
                    {message.metadata.sessionId.slice(-8)}
                  </span>
                </div>
              )}
            </div>
