...
export function checkCompleteness(
  ...
  if (data.symptom_characteristics?.duration_description === 'unknown')
    missingFields.push('duration_description')
  if (data.symptom_characteristics?.pain_intensity_scale === null)
    missingFields.push('pain_intensity_scale')
  ...
  const hasCriticalIssues =
    medicalValidation.hasContradictions || medicalValidation.hasInconsistencies
