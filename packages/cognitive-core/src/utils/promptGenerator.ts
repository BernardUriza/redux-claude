...
function buildStructuredMedicalPrompt(data: MedicalExtractionOutput): string {
  ...
  sections.push('\n🎯 INSTRUCCIÓN:')
  sections.push('Por favor genera un análisis médico SOAP completo basado en la información proporcionada, incluyendo diagnósticos diferenciales, plan de manejo y recomendaciones de seguimiento según las normas médicas mexicanas NOM.')
