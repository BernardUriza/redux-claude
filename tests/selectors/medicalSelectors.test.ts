  ...
  describe('selectSystemMetrics', () => {
    ...
    it('should calculate system metrics from multiple cores', () => {
      ...
      const assistantMessages = [
        createMockMessage({ confidence: 0.85 })
      ]
    ...
    it('should determine system health correctly', () => {
      const highConfidenceMessages = Array(10).fill(null).map(() => 
        createMockMessage({ confidence: 0.95 })
      )
  ...
  describe('selectPhysicianNotes', () => {
    ...
    it('should convert medical messages to physician notes', () => {
      const messages: MedicalMessage[] = [
        createMockMessage({
          type: 'assistant',
          content: 'Patient presents with classic symptoms of hypertension. Recommending lifestyle changes and medication.',
          confidence: 0.9,
          metadata: { sectionType: 'diagnosis' }
        }),
        createMockMessage({
    ...
    it('should filter out short messages', () => {
      const messages: MedicalMessage[] = [
        ...
        createMockMessage({
          type: 'assistant',
          content: 'This is a proper medical note with sufficient detail for documentation purposes.',
          metadata: { sectionType: 'diagnosis' }
        })
      ]
